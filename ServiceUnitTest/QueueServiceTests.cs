...
namespace Service.UnitTest
{
    ...
    {
        private string queuePath = @"FormatName:DIRECT=OS:RD03-Web\private$\TransactionalQueue";
        ...
        {
            this.service = new QueueService(this.queuePath);
        ...
        [TestMethod]
        public void SendInternalReceiveTest_傳送Student_預期接收一樣的Student()
        {
            var student =
                new Student()
                {
            ...
            var actual = this.service.InternalReceive(TimeSpan.FromSeconds(10));
        ...
        [Ignore]
        [TestMethod]
        public void SendExternalReceiveTest_傳送Student_預期接收一樣的Student()
        {
            var student =
                new Student()
                {
            ...
            var actual = this.service.ExternalReceive(TimeSpan.FromSeconds(10));
